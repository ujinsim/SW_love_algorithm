...
export default function Certification({ onSubmit }) {
  ...
  return (
    <section className="bg-gradient-to-b from-white via-purple-500 to-pink-500 min-h-screen w-full overflow-hidden flex items-center justify-center">
      <div className="w-[90%] max-w-md bg-gradient-to-b from-white rounded-3xl shadow-xl p-8 text-center">
