      ...
      <div className="flex animate-slide">
        {types.map((item, index) => {
          ...
          return (
            <button
              key={index}
              className={`flex items-center justify-center border-2 border-stone-100 rounded-3xl pl-2 pr-2 text-center h-12 w-auto min-w-[100px] ${gradient} gap-2 bg-opacity-10`}
            >
