...
export default function TitleContent({ subtitle, title, content, onClick }) {
  return (
    <div className="rounded-4xl border border-transparent flex justify-start w-full flex-col max-w-80 pt-5">
      <div className="pb-1 text-base text-white">{subtitle}</div>
